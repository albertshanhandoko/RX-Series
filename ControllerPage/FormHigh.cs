...
{
    public partial class FormHigh : Form
    {
        public FormHigh()
        {
            InitializeComponent();
        ...
        private void button_numpad_ent_Click(object sender, EventArgs e)
        {
            ...
            Global.highinterval = float.Parse(numericUpDown1.Value.ToString());
            Global.highpcs = float.Parse(numericUpDown2.Value.ToString());
